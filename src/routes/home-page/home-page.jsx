...
const HomePage = () => {
  ...
  const getTimeZone = async () => {
    const timeIndex = [
      shortData.dt,
      longData.list[0].dt,
      shortData.sys.sunrise,
      shortData.sys.sunset,
    ];
    ...
    try {
      ...
      const response1 = await fetch(
        `https://api.timezonedb.com/v2.1/get-time-zone?key=SVNGZIIGU6IT&format=json&by=position&lat=${lat}&lng=${lon}&time=${time}`
      );
      ...
      const perbedaanMenit1 = Math.floor(
        (perbedaan1 % (1000 * 60 * 60)) / (1000 * 60)
      );
      ...
      const perbedaanMenit = Math.floor(
        (perbedaan % (1000 * 60 * 60)) / (1000 * 60)
      );
      ...
      if (new Date(timeIndex[0] * 1000) > new Date(timeZone[0])) {
        ...
        sunriseMinutes =
          new Date(timeIndex[2] * 1000).getMinutes() - perbedaanMenit;
        sunsetHours = new Date(timeIndex[3] * 1000).getHours() - perbedaanJam;
        sunsetMinutes =
          new Date(timeIndex[3] * 1000).getMinutes() - perbedaanMenit;
        if (sunriseMinutes < 0) {
    ...
    <div className="home-page-div">
      <header className={color ? "app-header div-bg-color" : "app-header"}>
        <h1 className="home-logo">
          Weather{" "}
          {now.getHours() < 18 ? (
            <img className="home-sun-icon" src={sun} alt="sun-icon" />
          ) : (
            <img className="home-moon-icon" src={moon} alt="sun-icon" />
          )}
        </h1>
      ...
      <main className="home-main">
        <section className="first-section">
          <section className="left-first-section">
            <h3 className="city-name">
              {shortData
                ? shortData.name + ` (${shortData.sys.country})`
                : "Unknown City"}
            </h3>
            <div className="weather-container">
              <div className="sub-weather-container1">
                {shortData && shortData.weather && (
                  <WeatherIcons
                    weatherType={`w${shortData.weather[0].icon}`}
                ...
                >
                  {shortData
                    ? shortData.weather[0].description[0].toUpperCase() +
                      shortData.weather[0].description.slice(1, 45)
                    : "not known"}
                </marquee>
              </div>
              <div className="sub-weather-container2">
                <h3 className="weather-info1">
                  {shortData
                    ? (shortData.main.temp - 273.15).toFixed(0) + " \u00B0C"
                    : "0"}
                </h3>
                <h3 className="weather-info2">
                  {localTime
                    ? new Date(localTime[0]).toLocaleDateString(
                        "en-US",
                        options
                      ) +
                      " " +
                      (shortData.main.temp_max - 273.15).toFixed(0) +
                      "\u00B0 / " +
                      (shortData.main.temp_min - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
            ...
            <div className="long-info-container">
              <div className="sub-long-info-container">
                ...
                {shortData && shortData.weather && (
                  <WeatherIcons
                    weatherType={`w${shortData.weather[0].icon}`}
                    className="weather-long-info-icon"
                  />
                )}
                <h3 className="weather-long-info">
                  {shortData
                    ? (shortData.main.temp - 273.15).toFixed(0) + "\u00B0"
                    : "0"}
                </h3>
              </div>
              <div className="sub-long-info-container1">
                <h3>{localTime ? localTime[1] : "0"}</h3>
                {longData && longData.list && (
                  <WeatherIcons
                    weatherType={`w${longData.list[0].weather[0].icon}`}
                    className="weather-long-info-icon"
                  />
                )}
                <h3 className="weather-long-info">
                  {longData && longData.list
                    ? (longData.list[0].main.temp - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
              <div className="sub-long-info-container1">
                ...
                {longData && longData.list && (
                  <WeatherIcons
                    weatherType={`w${longData.list[1].weather[0].icon}`}
                    className="weather-long-info-icon"
                  />
                )}
                <h3 className="weather-long-info">
                  {longData && longData.list
                    ? (longData.list[1].main.temp - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
              <div className="sub-long-info-container1">
                ...
                {longData && longData.list && (
                  <WeatherIcons
                    weatherType={`w${longData.list[2].weather[0].icon}`}
                    className="weather-long-info-icon"
                  />
                )}
                <h3 className="weather-long-info">
                  {longData && longData.list
                    ? (longData.list[2].main.temp - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
              <div className="sub-long-info-container1">
                ...
                {longData && longData.list && (
                  <WeatherIcons
                    weatherType={`w${longData.list[3].weather[0].icon}`}
                    className="weather-long-info-icon"
                  />
                )}
                <h3 className="weather-long-info">
                  {longData && longData.list
                    ? (longData.list[3].main.temp - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
        ...
        <section className="second-section">
          <section className="left-second-section">
            <div className="sub-left-second-section">
              <div className="adv-weather-container">
                <img
                  className="adv-weather-icon"
                  src={feelsIcon}
                  alt="feels-like-icon"
                />
                <h3 className="adv-weather-info">Feels like</h3>
                <h3 className="adv-weather-info1">
                  {shortData
                    ? (shortData.main.feels_like - 273.15).toFixed(0) +
                      " \u00B0C"
                    : "0"}
                </h3>
              </div>
              <div className="adv-weather-container1">
                ...
                <h3 className="adv-weather-info1">
                  {shortData
                    ? (shortData.wind.speed * 3.6).toFixed(0) + " km/h"
                    : "0"}
                </h3>
              </div>
              <div className="adv-weather-container1">
                ...
                <h3 className="adv-weather-info1">
                  {shortData ? shortData.main.humidity + "%" : "0"}
                </h3>
              </div>
            </div>
            <div className="sub-left-second-section sub-bottom">
              <div className="adv-weather-container">
                ...
                <h3 className="adv-weather-info1">
                  {shortData
                    ? (shortData.visibility / 1000).toFixed(0) + " km"
                    : "0"}
                </h3>
              </div>
              <div className="adv-weather-container1">
                ...
                <h3 className="adv-weather-info1">
                  {shortData ? shortData.main.pressure + " hPa" : "0"}
                </h3>
              </div>
              <div className="adv-weather-container2">
                <div className="first-sub-adv-weather-container2">
                  ...
                  <h3 className="adv-weather-info1 sun-info1">
                    {localTime ? localTime[5] : "0"}
                  </h3>
                </div>
          ...
          <section className="right-second-section">
            <div>
              <h3 className="days-forecast-title">
                4-days forecast at {localTime ? localTime[1] : "0"}
              </h3>
            </div>
            <div className="sub-right-second-section">
              <div className="sub-sub-right-second-section">
                ...
                {longData && longData.list && (
                  <WeatherIcons
                    weatherType={`w${longData.list[8].weather[0].icon}`}
                    className="second-section-weather-icon"
                  />
                )}
                <marquee
                  className="second-section-weather-info"
                  direction="left"
                  scrollamount="3"
                >
                  {longData
                    ? longData.list[8].weather[0].description[0].toUpperCase() +
                      longData.list[8].weather[0].description.slice(1, 35)
                    : "not known"}
                </marquee>
                <h3 className="right-second-section-weather-info">
                  {longData
                    ? (longData.list[8].main.temp_max - 273.15).toFixed(0) +
                      "\u00B0 / " +
                      (longData.list[8].main.temp_min - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
              <div className="sub-sub-right-second-section1">
                <h3 className="second-section-weather-day">
                  {longData
                    ? new Date(longData.list[16].dt_txt).toLocaleDateString(
                        "en-US",
                        { weekday: "short" }
                      )
                    : "not known"}
                ...
                {longData && longData.list && (
                  <WeatherIcons
                    weatherType={`w${longData.list[16].weather[0].icon}`}
                    className="second-section-weather-icon"
                  />
                )}
                <marquee
                ...
                >
                  {longData
                    ? longData.list[16].weather[0].description[0].toUpperCase() +
                      longData.list[16].weather[0].description.slice(1, 35)
                    : "not known"}
                </marquee>
                <h3 className="right-second-section-weather-info">
                  {longData
                    ? (longData.list[16].main.temp_max - 273.15).toFixed(0) +
                      "\u00B0 / " +
                      (longData.list[16].main.temp_min - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
              <div className="sub-sub-right-second-section2">
                <h3 className="second-section-weather-day">
                  {longData
                    ? new Date(longData.list[24].dt_txt).toLocaleDateString(
                        "en-US",
                        { weekday: "short" }
                      )
                    : "not known"}
                ...
                {longData && longData.list && (
                  <WeatherIcons
                    weatherType={`w${longData.list[24].weather[0].icon}`}
                    className="second-section-weather-icon"
                  />
                )}
                <marquee
                ...
                >
                  {longData
                    ? longData.list[24].weather[0].description[0].toUpperCase() +
                      longData.list[24].weather[0].description.slice(1, 35)
                    : "not known"}
                </marquee>
                <h3 className="right-second-section-weather-info">
                  {longData
                    ? (longData.list[24].main.temp_max - 273.15).toFixed(0) +
                      "\u00B0 / " +
                      (longData.list[24].main.temp_min - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
              <div className="sub-sub-right-second-section3">
                <h3 className="second-section-weather-day">
                  {longData
                    ? new Date(longData.list[32].dt_txt).toLocaleDateString(
                        "en-US",
                        { weekday: "short" }
                      )
                    : "not known"}
                ...
                {longData && longData.list && (
                  <WeatherIcons
                    weatherType={`w${longData.list[32].weather[0].icon}`}
                    className="second-section-weather-icon"
                  />
                )}
                <marquee
                ...
                >
                  {longData
                    ? longData.list[32].weather[0].description[0].toUpperCase() +
                      longData.list[32].weather[0].description.slice(1, 35)
                    : "not known"}
                </marquee>
                <h3 className="right-second-section-weather-info">
                  {longData
                    ? (longData.list[32].main.temp_max - 273.15).toFixed(0) +
                      "\u00B0 / " +
                      (longData.list[32].main.temp_min - 273.15).toFixed(0) +
                      "\u00B0"
                    : "0"}
                </h3>
              </div>
